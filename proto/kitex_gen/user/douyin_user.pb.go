...
type DouyinUserLoginRequest struct {
	...
	Username *string `protobuf:"bytes,1,req,name=username" json:"username,omitempty"` // 登录用户名，最长32个字符
...
func (x *DouyinUserLoginRequest) Reset() {
	*x = DouyinUserLoginRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[0]
...
func (*DouyinUserLoginRequest) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinUserLoginResponse) Reset() {
	*x = DouyinUserLoginResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserLoginResponse) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinUserRegisterRequest) Reset() {
	*x = DouyinUserRegisterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRegisterRequest) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{2}
}
...
func (x *DouyinUserRegisterResponse) Reset() {
	*x = DouyinUserRegisterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRegisterResponse) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{3}
}
...
type DouyinUserRequest struct {
	...
	MyId  *int64  `protobuf:"varint,1,req,name=my_id,json=myId" json:"my_id,omitempty"` // 用户id
...
func (x *DouyinUserRequest) Reset() {
	*x = DouyinUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserRequest) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{4}
}

func (x *DouyinUserRequest) GetMyId() int64 {
	if x != nil && x.MyId != nil {
		return *x.MyId
	}
	return 0
...
func (x *DouyinUserResponse) Reset() {
	*x = DouyinUserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinUserResponse) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{5}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_douyin_user_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_douyin_user_proto_rawDescGZIP(), []int{6}
}
...
var File_douyin_user_proto protoreflect.FileDescriptor

var file_douyin_user_proto_rawDesc = []byte{
	0x0a, 0x11, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x53, 0x0a, 0x19, 0x64, 0x6f, 0x75,
	...
	0x20, 0x02, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x8b,
	...
	0x04, 0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x56, 0x0a, 0x1c,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x40, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f,
	0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x13, 0x0a, 0x05,
	0x6d, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x03, 0x52, 0x04, 0x6d, 0x79, 0x49,
	0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x76, 0x0a, 0x14, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x1e, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x03, 0x20, 0x02, 0x28, 0x0b, 0x32, 0x0a, 0x2e,
	...
	0x6c, 0x6f, 0x77, 0x42, 0x21, 0x5a, 0x1f, 0x6d, 0x79, 0x64, 0x6f, 0x75, 0x73, 0x68, 0x65, 0x6e,
	0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65,
	0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72,
}

var (
	file_douyin_user_proto_rawDescOnce sync.Once
	file_douyin_user_proto_rawDescData = file_douyin_user_proto_rawDesc
)

func file_douyin_user_proto_rawDescGZIP() []byte {
	file_douyin_user_proto_rawDescOnce.Do(func() {
		file_douyin_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_douyin_user_proto_rawDescData)
	})
	return file_douyin_user_proto_rawDescData
}

var file_douyin_user_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_douyin_user_proto_goTypes = []interface{}{
...
var file_douyin_user_proto_depIdxs = []int32{
...
func init() { file_douyin_user_proto_init() }
func file_douyin_user_proto_init() {
	if File_douyin_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_douyin_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_douyin_user_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_douyin_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_douyin_user_proto_goTypes,
		DependencyIndexes: file_douyin_user_proto_depIdxs,
		MessageInfos:      file_douyin_user_proto_msgTypes,
	}.Build()
	File_douyin_user_proto = out.File
	file_douyin_user_proto_rawDesc = nil
	file_douyin_user_proto_goTypes = nil
	file_douyin_user_proto_depIdxs = nil
}
